...
public class BroadcastReceiverActivity extends AppCompatActivity implements WifiP2pManager.ConnectionInfoListener{
    ...
    private PeerListListener peerListListener = new PeerListListener() {
        ...
        public void onPeersAvailable(WifiP2pDeviceList peerList) {
            ...
            peersNameFixed.addAll(peerList.getDeviceList());
            Toast.makeText(BroadcastReceiverActivity.this,"peers count = "+peersNameFixed.size(),Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                {
                    if(wd.deviceName.equals(tv.getText().toString()))
                        device = wd;
                }
                if(device != null)
                {
  ...
  /*  @Override
    ...
    public void onRefresh(View view) {
        mManager.discoverPeers(mChannel, new WifiP2pManager.ActionListener() {
            ...
            public void onSuccess() {
                //will not provide info about who it discovered
                Toast.makeText(BroadcastReceiverActivity.this,"success discover for peers",Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(int reasonCode) {
                Toast.makeText(BroadcastReceiverActivity.this,"something goes wrong!",Toast.LENGTH_SHORT).show();
            }
        });
    }
